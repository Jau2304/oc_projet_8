...
CSV_NAME_FILE = "csv/preprocessed/app_test.csv"

def display_prediction(prediction) :
    if prediction == 0 :
        st.write("La demande d'emprunt est acceptee.")
    else :
        st.write("La demande d'emprunt est refusee.")
